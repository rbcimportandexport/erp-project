...
const priorityConfig = {
  red: {
    ...
    panelClass: "border-red-200 bg-red-50/40 text-slate-900 hover:bg-red-50/70 hover:border-red-300",
  ...
  yellow: {
    ...
    panelClass: "border-amber-200 bg-amber-50/40 text-slate-900 hover:bg-amber-50/70 hover:border-amber-300",
  ...
  green: {
    ...
    panelClass: "border-emerald-200 bg-emerald-50/40 text-slate-900 hover:bg-emerald-50/70 hover:border-emerald-300",
